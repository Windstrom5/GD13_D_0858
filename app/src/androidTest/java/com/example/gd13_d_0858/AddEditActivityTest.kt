package com.example.gd13_d_0858
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Carl Johnson"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200710858"), closeSoftKeyboard())
        onView(isRoot()).perform(waitFor(3000))
